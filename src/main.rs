...
fn main() -> Result<()> {
    ...
    //let pass_6 = behemoth5(&pass_5)?;
    let _pass_7 = behemoth6("cBucvF0OhB"); //(&pass_6)?;
    // let pass_8 = behemoth7(&pass_7)?;
    // behemoth8(&pass_8)?;
...
fn behemoth6(password: &str) -> Result<String> {
    ...
    let session = ssh_session("behemoth6", password)?;
    let mut channel = session.channel_session()?;
    create_shell(&mut channel)?;
...
fn behemoth7(password: &str) -> Result<String> {
    
    let session = ssh_session("behemoth7", password)?;
    let mut channel = session.channel_session()?;
    create_shell(&mut channel)?;
...
fn behemoth8(password: &str) -> Result<String> {
    
    let session = ssh_session("behemoth8", password)?;
    let mut channel = session.channel_session()?;
    create_shell(&mut channel)?;
